...
-- --------------------------------------------------
-- Date Created: 06/07/2017 14:57:49
-- Generated from EDMX file: C:\Users\john\Documents\Visual Studio 2017\Projects\WLA\WLA\WLAEntity.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_FungsiWLA]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[WLATrx] DROP CONSTRAINT [FK_FungsiWLA];
GO
IF OBJECT_ID(N'[dbo].[FK_JabatanWLA]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[WLATrx] DROP CONSTRAINT [FK_JabatanWLA];
GO
...
-- Creating foreign key on [Fungsi_Id] in table 'WLATrx'
ALTER TABLE [dbo].[WLATrx]
ADD CONSTRAINT [FK_FungsiWLA]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FungsiWLA'
CREATE INDEX [IX_FK_FungsiWLA]
ON [dbo].[WLATrx]
    ([Fungsi_Id]);
GO

-- Creating foreign key on [Jabatan_Id] in table 'WLATrx'
ALTER TABLE [dbo].[WLATrx]
ADD CONSTRAINT [FK_JabatanWLA]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_JabatanWLA'
CREATE INDEX [IX_FK_JabatanWLA]
ON [dbo].[WLATrx]
    ([Jabatan_Id]);
GO
